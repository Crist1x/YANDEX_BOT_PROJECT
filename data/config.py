...
1. <b>Сюрпризы</b> - бот пришлет вам подборку самых милых подарков для вашей второй половинки.
2. <b>Прогулка</b> - бот найдет за вас самые романтичные места в городе.
"""

DESCR = "<b>L’amour fou</b> - это ваш помощник, который облегчет вам выбор фильма, \
