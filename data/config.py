...
STUFF = {1: ["https://card.wb.ru/cards/detail?spp=0&regions=80,64,38,4,115,83,33,68,70,69,30,86,75,40,1,66,31,48,110,"
         ...
         2: ["https://card.wb.ru/cards/detail?spp=0&regions=80,64,38,4,115,83,33,68,70,69,30,86,75,40,1,66,31,48,110,"
             "22,71,111&pricemarginCoeff=1.0&reg=0&appType=1&emp=0&locale=ru&lang=ru&curr=rub&couponsGeo=12,3,18,15,"
...
1. Сюрпризы - бот пришлет вам подборку самых милых подарков для вашей второй половинки.
2. Прогулка - бот найдет за вас самые романтичные места в городе.
"""

DESCR = "L’amour fou - это ваш помощник, который облегчет вам выбор фильма, \
места для прогулки, подарка и остальных романтических вещей для своей второй половинки❤️‍🔥"